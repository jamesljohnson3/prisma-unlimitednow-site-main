...
const Search = props => {
  ...
  return (
    <div className="search-and-results-container">
      ...
      <div class="BeOpWidget" data-content="62afe2cdb22ab378a3bcd621"></div><div class="arena-chat" data-publisher="unlimited-now" data-chatroom="unlimited-now-global" data-position="overlay"></div><script async src="https://go.arena.im/public/js/arenachatlib.js?p=unlimited-now&e=unlimited-now-global"></script>
</div>
  )
}
